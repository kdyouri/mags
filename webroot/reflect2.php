...
if (isset($_GET['img']))
{
    ...
    $source_image = $_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . 'refl_.jpg';
    if (file_exists($source_image)) unlink($source_image);
...
//    }
    ...
    if ($data) file_put_contents($source_image, $data);
